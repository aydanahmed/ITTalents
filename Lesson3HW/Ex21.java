	...
	public static void main(String[] args) {
		...
		for(int i=a; i<=52; i++) {
			...
			case 36:
				...
				break;
			case 37:
				System.out.print("J clubs"+ ",");
				break;
			case 38:
				System.out.print("J diamonds"+ ",");
				break;
			case 39:
				System.out.print("J hearts"+ ",");
				break;
			case 40:
				System.out.print("J spades"+ ",");
				break;
			case 41:
				System.out.print("Q clubs"+ ",");
				break;
			case 42:
				System.out.print("Q diamonds"+ ",");
				break;
			case 43:
				System.out.print("Q hearts"+ ",");
				break;
			case 44:
				System.out.print("Q spades"+ ",");
				break;
			case 45:
				System.out.print("K clubs"+ ",");
				break;
			case 46:
				System.out.print("K diamonds"+ ",");
				break;
			case 47:
				System.out.print("K hearts"+ ",");
				break;
			case 48:
				System.out.print("K spades"+ ",");
				break;
			case 49:
				System.out.print("A clubs"+ ",");
				break;
			case 50:
				System.out.print("A diamonds"+ ",");
				break;
			case 51:
				System.out.print("A hearts"+ ",");
				break;
			case 52:
				System.out.print("A spades"+ ".");
				break;
			}
		}
